  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <div
          className="absolute bottom-1/4 -right-20 w-80 h-80 bg-indigo-400/30 rounded-full blur-3xl animate-pulse"
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-32 pb-20 lg:pt-40 lg:pb-32">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <div className="text-sm text-slate-500">
                        Lincoln Elementary &bull; January 6, 2026
                      </div>
                    </div>
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-500">
                          Grade 7 &bull; 4 absences this month
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
                  ...
                  <div className="bg-white rounded-lg shadow-sm p-4 flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <div className="text-sm text-slate-500">
                          Grade 5 &bull; 3 absences this month
                        </div>
                      </div>
                    </div>
                    <div className="flex items-center gap-3">
            ...
            {/* Floating Elements */}
            <div
              className="absolute -top-4 -right-4 lg:-right-8 bg-white rounded-xl shadow-xl p-4 animate-float"
            ...
            <div
              className="absolute -bottom-4 -left-4 lg:-left-8 bg-white rounded-xl shadow-xl p-4 animate-float"
              style={{ animationDelay: '1s' }}
            >
              <div className="flex items-center gap-3">
