...
const CTASection: React.FC<CTASectionProps> = ({ formRef }) => {
  return (
    <section id="contact" className="py-24 bg-gradient-to-br from-blue-700 via-blue-800 to-indigo-950 relative overflow-hidden">
      {/* Background Elements */}
